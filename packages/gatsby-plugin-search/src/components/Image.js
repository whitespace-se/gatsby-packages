/**
 * This is a copy of the Image component in
 * @whitespace/gatsby-theme-wordpress-basic because if we were to import it from
 * there, we would get a circular dependency.
 */
